  ...
  const services = [
    {
      ...
      description:
        "Expertly managed portfolios tailored to your risk tolerance and financial goals.",
      features: [
        "Risk assessment",
    ...
    },
    {
      ...
      description:
        "In-depth research and analysis to identify high-potential investment opportunities.",
    ...
    },
    {
      ...
      description:
        "Comprehensive risk assessment and mitigation strategies for your investments.",
      features: [
        "Loss prevention",
    ...
    <>
      <div className="container flex flex-col items-center mx-auto sm:px-6 md:px-12 xl:px-32 py-20 text-primary-navy">
        <div className={"text-center mb-16 mx-4"}>
          ...
          <p
            className={
              "text-base sm:text-xl text-charcoal text-wrap max-w-3xl mx-auto"
            }
          >
            Comprehensive investment solutions designed to maximize your returns
            while managing risk effectively.
          </p>
        </div>
        <div
          className={"grid grid-cols-1 md:grid-cols-3 gap-8 text-charcoal mx-4"}
        >
          {services.map((service, index) => (
            <div
              key={index}
              className={
                "bg-white border-0 shadow-lg hover:shadow-xl transition-shadow rounded-lg"
              }
            >
              {" "}
              {/* Card container */}
              <div className={"flex flex-col space-y-1.5 p-6 text-center"}>
                ...
                <div
                  className={
                    "text-primary-navy text-xl font-semibold leading-none tracking-tight"
                  }
                >
                  {service.title}
                </div>
              ...
              <div className={"p-6 pt-0 place-items-center-safe"}>
                {" "}
                {/* Card content */}
